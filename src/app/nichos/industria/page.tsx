...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.suportedelivery.com/nichos/industria",
  },
};
    ...
    <>
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold">🏭 TI para Indústria</h1>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl">
            <h2 className="text-2xl font-bold">Desafios do Setor Industrial</h2>
            ...
            <div className="mt-6 space-y-4">
              <div className="rounded-xl bg-gray-50 p-6">
                <h3 className="font-semibold">Redes Industriais</h3>
              ...
              <div className="rounded-xl bg-gray-50 p-6">
                <h3 className="font-semibold">Automação e SCADA</h3>
                <p className="mt-2 text-sm text-gray-600">
              ...
              <div className="rounded-xl bg-gray-50 p-6">
                <h3 className="font-semibold">Segurança de Rede</h3>
                <p className="mt-2 text-sm text-gray-600">
              ...
              <div className="rounded-xl bg-gray-50 p-6">
                <h3 className="font-semibold">Suporte Emergencial</h3>
                <p className="mt-2 text-sm text-gray-600">
